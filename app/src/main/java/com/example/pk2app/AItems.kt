...
class AItems : AppCompatActivity() , NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_aitems)
        ...
        drawer = findViewById(R.id.drawerLayoutItems)
        ...
        val navigationView: NavigationView = findViewById(R.id.navViewItems)
