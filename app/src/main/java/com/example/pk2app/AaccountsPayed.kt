...
class AaccountsPayed : AppCompatActivity() , NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_aaccounts_payed)
        ...
        drawer = findViewById(R.id.drawerLayoutAccounts)
        ...
        val navigationView: NavigationView = findViewById(R.id.navViewAccounts)
